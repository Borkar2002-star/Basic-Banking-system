...
<html lang="en">
  ...
  <title>Bank Of Spark Foundation</title>
...
<!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark  sticky-top" style="background-color: #22ddc4;">
...
<!-- End Navbar -->
  ...
  <!-- Table -->
  <div class="container">
        <h2 class="text-center pt-4" style="color : #22ddc4;margin-top: 30px;">Transfer Money</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : #354046;">
                        <td class="py-2"><?php echo $rows['id'] ?></td>
                        <td class="py-2"><?php echo $rows['name']?></td>
                        <td class="py-2"><?php echo $rows['email']?></td>
                        <td class="py-2"><?php echo $rows['balance']?></td>
                        <td><a href="userdetails.php?id= <?php echo $rows['id'] ;?>"> <button style="color:#22ddc4" class="btn btn-outline-light btn">View and Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
